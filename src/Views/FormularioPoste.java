...
public class FormularioPoste extends javax.swing.JFrame {
    ...
    public FormularioPoste() {
        initComponents();
       preencherTabela("select *from poste order by etiqueta"); 
    }
    ...
    private void initComponents() {
        ...
        jcbMaterialPoste.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jcbMaterialPosteActionPerformed(evt);
            }
        });
        ...
        jbExcluirCadastroPoste.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbExcluirCadastroPosteActionPerformed(evt);
            }
        });
    ...
    private void jbExcluirCadastroPosteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbExcluirCadastroPosteActionPerformed
      ...
      preencherTabela("select *from poste order by etiqueta");
    }//GEN-LAST:event_jbExcluirCadastroPosteActionPerformed

    private void jcbMaterialPosteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jcbMaterialPosteActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jcbMaterialPosteActionPerformed

    
    
    public void preencherTabela(String Sql){
        ArrayList dados = new ArrayList();
        String[] colunas = new String[]{"etiqueta","altura","material","latitude","longitude","Ponto de Distribuiçao"};
        conex.coneccao();
        ...
        try{
            conex.rs.first();
                    do{
                        dados.add(new Object[]{conex.rs.getInt("etiqueta"),
                            conex.rs.getFloat("altura"),conex.rs.getString("material"),
                            conex.rs.getFloat("latitude"),conex.rs.getFloat("longitude"),
                            conex.rs.getFloat("latitude"),conex.rs.getFloat("ponto_de_distribuicao_etiqueta")});
                        
                        
                    }while(conex.rs.next());
        }catch(SQLException ex){
        JOptionPane.showMessageDialog(rootPane, "ERRO ARRAY LIST PREENCHER"+ex);
        }
          ModeloTabela modelo = new ModeloTabela(dados,colunas);
            
        jTablePostesCadastrados.setModel(modelo);
        jTablePostesCadastrados.getColumnModel().getColumn(0).setPreferredWidth(80); // tamanho tabela
        jTablePostesCadastrados.getColumnModel().getColumn(0).setResizable(false);
        jTablePostesCadastrados.getColumnModel().getColumn(1).setPreferredWidth(80); // tamanho tabela
        jTablePostesCadastrados.getColumnModel().getColumn(1).setResizable(false);
        jTablePostesCadastrados.getColumnModel().getColumn(2).setPreferredWidth(80); // tamanho tabela
        jTablePostesCadastrados.getColumnModel().getColumn(2).setResizable(false);
        jTablePostesCadastrados.getColumnModel().getColumn(3).setPreferredWidth(80); // tamanho tabela
        jTablePostesCadastrados.getColumnModel().getColumn(3).setResizable(false);
        jTablePostesCadastrados.getColumnModel().getColumn(4).setPreferredWidth(80); // tamanho tabela
        jTablePostesCadastrados.getColumnModel().getColumn(4).setResizable(false);
        jTablePostesCadastrados.getColumnModel().getColumn(5).setPreferredWidth(80); // tamanho tabela
        jTablePostesCadastrados.getColumnModel().getColumn(5).setResizable(false);
        jTablePostesCadastrados.getTableHeader().setReorderingAllowed(false);
        jTablePostesCadastrados.setAutoResizeMode(jTablePostesCadastrados.AUTO_RESIZE_OFF);
        jTablePostesCadastrados.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        conex.desconecta();
    }
